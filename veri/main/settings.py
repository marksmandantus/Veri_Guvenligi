...
SECRET_KEY = 'django-insecure-ex598+et%fa7!j!#1clp4)4n)tcpxtz1bs#q!yc7xayyaw-9ed'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'uploads')  # 'uploads' klasörünün yolunu belirtin
MEDIA_URL = '/media/'
